...
>
> **源文档同步（2026-09-18）**：以上处置**已落到源头文档**——
> A1/A8 → 读解 §十四、§十五；A2 → 读解 §十五（+ `01-source-reading/generic-family-definition.md`）；
> A3 → 综合报告 §三；A7 → 算例三。
> A4/A5/A6/A9/A10 属**总报告层的表述限定**，源文档相应处已一致。
...
*报告版本：v1.2（2026-09-17 勘误：D7 稳定阈值限定 `0≤d≤1`，补分段条件与上界；更新：并入 V10 隐含前提审计结果——新增 §5.2、§四#13，并落实 A1–A10 的 10 条前提补丁；2026-09-18 补：§5.2 标注"源文档同步"）*
*时间：2026-09-17*
