...
> **前提（V10·A3）**：本节的动力学结论，建立在"**把五行取作 `C₅` 环耦合 + 线性衰减/相生**"这一**构造性模型**之上——这是**建模选择，不是从五行推导出来的**。给定该模型后，以下 `ρ` 与稳定性判据均为严格结论。
...
*报告版本：v1.2（2026-09-17 勘误：§3.3 稳定阈值限定 d≤1；2026-09-18 补：§三 加 V10·A3 前提注——动力学模型是构造性建模，非推导）*
*时间：2026-09-17*
